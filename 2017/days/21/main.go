...
func Day21First(isProd bool) (int, error) {
	example, prod, err := utils.ReadTextsOfDay("21")
	if err != nil {
		return 0, err
	}
	var input string
...
func Day21Second(isProd bool) (int, error) {
	example, prod, err := utils.ReadTextsOfDay("21")
	if err != nil {
		return 0, err
	}
...
func part1(content string) int {
	rules := parse(strings.Split(content, "\n"))
	m := newMap(rules)
...
func getInput(content string) []string {
