...
func (d Day15) duelingGenerators(input string, part int) int {
...
func (d Day15) getNextValue(value, factor, divisor, criteria int) int {
	for {
...
func (d Day15) parse(input string) []int {
	var ans []int
