...
func (d Day24) backtrack(lastVal int, edges [][2]int, usedEdges map[int]bool) (maxStr, maxLen, maxLenStr int) {
...
func (d Day24) calcStrengthOfBridge(bridge [][2]int) int {
	var sum int
...
func (d Day24) getEdges(input string) (edges [][2]int) {
