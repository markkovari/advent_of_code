...
func (d Day18) newComputer(input string, id int) *Day18Computer {
	prog := [][]string{}
	...
	return &Day18Computer{program: prog, regs: map[string]int{"p": id}}
}

func (c *Day18Computer) getValue(s string) int {
...
func (c *Day18Computer) set(reg string, val int) { c.regs[reg] = val }

func (c *Day18Computer) run(out *[]int, count *int) {
	c.blocked = false
