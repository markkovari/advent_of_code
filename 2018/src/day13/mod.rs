...
impl Cart {
    fn turn(&mut self) {
        self.dir = match self.dir {
            Direction::Up => match self.intersections % 3 {
                0 => Direction::Left,
                1 => Direction::Up,
                _ => Direction::Right,
            },
            Direction::Down => match self.intersections % 3 {
                0 => Direction::Right,
                1 => Direction::Down,
                _ => Direction::Left,
            },
            Direction::Left => match self.intersections % 3 {
                0 => Direction::Down,
                1 => Direction::Left,
                _ => Direction::Up,
            },
            Direction::Right => match self.intersections % 3 {
                0 => Direction::Up,
                1 => Direction::Right,
                _ => Direction::Down,
            },
...
impl Solution for Day13 {
        ...
        loop {
            ...
            for i in 0..carts.len() {
                ...
                match grid[next_pos.y][next_pos.x] {
                    ...
                    Track::CurveForward | Track::CurveBackward => {
                        next_cart.apply_curve(grid[next_pos.y][next_pos.x])
                    }
                    _ => {}
                }
                carts[i] = next_cart;
    ...
    fn part2(&self, input: &str) -> Result<String> {
        ...
        while carts.len() > 1 {
            ...
            for cart in carts {
                if crashed_this_tick.contains(&cart.pos) {
                    continue;
                }
